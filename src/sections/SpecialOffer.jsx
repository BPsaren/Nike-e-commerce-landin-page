  ...
  return (
    <section className="flex justify-between items-center max-xl:flex-col-reverse gap-10 max-container">
      <div className="flex-1">
        <img src={offer} width={524} height={522} className="w-full object-contain" />
      </div>
      <div className="flex flex-1 flex-col">
        ...
        <p className="mt-6 lg:max-w-lg info-text break-words">Navigate a realm of possibilities designed to fulfill your unique desires, surpassing 
